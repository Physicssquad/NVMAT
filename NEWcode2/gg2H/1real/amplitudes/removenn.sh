sed s/'p1.nv'/'(&)'/g amplitudes.m > outTemp2.m
...
sed s/'p1.nm'/'(&)'/g outTemp7.m > outTemp2.m

sed s/'p2.nm'/'(&)'/g outTemp2.m > outTemp3.m

sed s/'p3.nm'/'(&)'/g outTemp3.m > outTemp4.m

sed s/'p4.nm'/'(&)'/g outTemp4.m > outTemp5.m

sed s/'p5.nm'/'(&)'/g outTemp5.m > outTemp6.m

sed s/'p6.nm'/'(&)'/g outTemp6.m > outTemp7.m

cat  outTemp7.m > outTemp8.m

sed s/'mat ='/'&('/g  outTemp8.m > outTemp9.m
#sed s/';'/')&'/g outTemp9.m > out.m
#sed s/';'/')&'/g outTemp9.m > out2.m
cat  outTemp9.m > out2.m
