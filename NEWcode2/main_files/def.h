...
#enddo
      ;
Symbol ELTeltzbos,UPQupqzbos,ELTeltph,UPQupqph,
       UPQupqglu,glugluglu,BOTbotHig;
Symbol DQdqzbos,DQdqph,DQdqglu,BOTbotglu;
Symbol UPQupqzbos,wpboswmboszbos,wpboswmbosph;
Symbol DQupqwmbos,UPQdqwpbos;
Symbol gluglugluglu ;
Symbol glugluHig,gluglugluHig;
Symbol m,md,mz,me,mu,mH,mw,mb;
Symbol s,t,u;
Symbol qe,qu,qd,gew,sw,cw,gs,ch,gwwz,gwwa,gyuk;
Symbol cf,ca;
Symbol cve,cae,cvu,cau,cvd,cad;
