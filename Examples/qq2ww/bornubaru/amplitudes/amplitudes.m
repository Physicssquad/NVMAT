   ...
   mat0[1,3] =(
       ...
       + qu*gew^2 * (
          + 16*phprop[ - p1 - p2]*fprop[p2 - p3]*N*mw^4*gwwa
          - 24*phprop[ - p1 - p2]*fprop[p2 - p3]*N*u*mw^2*gwwa
          + 8*phprop[ - p1 - p2]*fprop[p2 - p3]*N*u^2*gwwa
          - 16*phprop[ - p1 - p2]*fprop[p2 - p3]*N*t*mw^2*gwwa
          + 24*phprop[ - p1 - p2]*fprop[p2 - p3]*N*t*u*gwwa
          - 8*phprop[ - p1 - p2]*fprop[p2 - p3]*N*t*u^2*mw^(-2)*gwwa
          - 16*phprop[ - p1 - p2]*fprop[p2 - p3]*N*s*mw^2*gwwa
          + 12*phprop[ - p1 - p2]*fprop[p2 - p3]*N*s*u*gwwa
          + 4*phprop[ - p1 - p2]*fprop[p2 - p3]*N*s*u^2*mw^(-2)*gwwa
          - 16*phprop[ - p1 - p2]*fprop[p2 - p3]*N*s*t*gwwa
          + 4*phprop[ - p1 - p2]*fprop[p2 - p3]*N*s*t*u*mw^(-2)*gwwa
          + 4*phprop[ - p1 - p2]*fprop[p2 - p3]*N*s*t*u^2*mw^(-4)*gwwa
          - 16*phprop[ - p1 - p2]*fprop[p2 - p3]*N*s^2*gwwa
          - 12*phprop[ - p1 - p2]*fprop[p2 - p3]*N*s^2*u*mw^(-2)*gwwa
          - 8*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*mw^4*gwwa
          + 8*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*u*mw^2*gwwa
          + 8*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*t*mw^2*gwwa
          - 8*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*t*u*gwwa
          + 8*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*mw^2*gwwa
          - 4*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*u^2*mw^(-2)*gwwa
          + 8*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*t*gwwa
          - 4*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*t*u*mw^(-2)*gwwa
          + 8*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s^2*gwwa
          + 4*phprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s^2*u*mw^(-2)*gwwa
          ));
   ...
   mat0[2,3] =(
       ...
       + gew^3*gwwz * (
          - 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*mw^4*cvu
          - 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*mw^4*cau
          + 24*zprop[ - p1 - p2]*fprop[p2 - p3]*N*u*mw^2*cvu
          + 24*zprop[ - p1 - p2]*fprop[p2 - p3]*N*u*mw^2*cau
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*N*u^2*cvu
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*N*u^2*cau
          + 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*t*mw^2*cvu
          + 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*t*mw^2*cau
          - 24*zprop[ - p1 - p2]*fprop[p2 - p3]*N*t*u*cvu
          - 24*zprop[ - p1 - p2]*fprop[p2 - p3]*N*t*u*cau
          + 8*zprop[ - p1 - p2]*fprop[p2 - p3]*N*t*u^2*mw^(-2)*cvu
          + 8*zprop[ - p1 - p2]*fprop[p2 - p3]*N*t*u^2*mw^(-2)*cau
          + 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*mw^2*cvu
          + 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*mw^2*cau
          - 12*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*u*cvu
          - 12*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*u*cau
          - 4*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*u^2*mw^(-2)*cvu
          - 4*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*u^2*mw^(-2)*cau
          + 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*t*cvu
          + 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*t*cau
          - 4*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*t*u*mw^(-2)*cvu
          - 4*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*t*u*mw^(-2)*cau
          - 4*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*t*u^2*mw^(-4)*cvu
          - 4*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s*t*u^2*mw^(-4)*cau
          + 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s^2*cvu
          + 16*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s^2*cau
          + 12*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s^2*u*mw^(-2)*cvu
          + 12*zprop[ - p1 - p2]*fprop[p2 - p3]*N*s^2*u*mw^(-2)*cau
          + 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*mw^4*cvu
          + 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*mw^4*cau
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*u*mw^2*cvu
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*u*mw^2*cau
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*t*mw^2*cvu
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*t*mw^2*cau
          + 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*t*u*cvu
          + 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*t*u*cau
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*mw^2*cvu
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*mw^2*cau
          + 4*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*u^2*mw^(-2)*cvu
          + 4*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*u^2*mw^(-2)*cau
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*t*cvu
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*t*cau
          + 4*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*t*u*mw^(-2)*cvu
          + 4*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s*t*u*mw^(-2)*cau
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s^2*cvu
          - 8*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s^2*cau
          - 4*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s^2*u*mw^(-2)*cvu
          - 4*zprop[ - p1 - p2]*fprop[p2 - p3]*n*N*s^2*u*mw^(-2)*cau
          ));
